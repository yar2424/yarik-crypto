...
from src.db.repositories.blofin.TickerTimeseries import get_ticker_timeseries
from src.services.blofin.scrape.get_ticker_data import get_all_symbols, get_tickers_data
from src.utils.telegram import send_message_broadcast

router = APIRouter()


@router.get("/scrape", tags=["blofin"])
async def scrape_all():
    return await get_tickers_data()


@router.get("/pairs", tags=["blofin"])
