...
# from src.services.lbank.notifications.historic.notifications.funding_rate_neg_3_ticks import (
#     get_notif_to_fire as get_notif_to_fire_funding_rate_neg_3_ticks,
# )
from src.services.lbank.notifications.historic.notifications.index_mark_3_ticks import (
    get_notif_to_fire as get_notif_to_fire_index_mark_3_ticks,
)
from src.services.lbank.notifications.historic.notifications.mark_last_3_ticks import (
...
def last_30_ticks_table_url_template(symbol: str):
    return f"{config['back_url']}/lbank/n_last_ticks_table?symbol={symbol}&n=30"
