...
from src.services.bingx.notifications.insta.notifications.fair_trade import (
    get_notif_to_fire as get_notif_to_fire_fair_trade,
)
from src.services.bingx.notifications.insta.notifications.funding_rate_neg_1 import (
    get_notif_to_fire as get_notif_to_fire_funding_rate_neg,
)
from src.services.bingx.notifications.insta.notifications.index_fair import (
...
"""
    ...
    if should_send_notif_rate_limit(full_notif_name):
        send_message_broadcast_chats(message_to_send, ["all", "prior", "individ_bingx"])
