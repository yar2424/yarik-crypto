...
# %%
ws = create_connection("wss://www.htx.com/futures/api/linear-swap-notification")
# %%
ws.send(
    '{"op":"auth","type":"token","token":"TpsMBbFVt0SnMEUkZQZ2MUkknU17mWx6psHBeOejMC0XtTcVzbqOZ5m8/bu7zv6ilM028qRNljwEmSqrSuYYPk4ztravsaV/F2VpiwNTbFaIAJL5kWm+1OEADvyKgmnDC+c3QA9ZzAUYkmKNCWXykllBJpzobRbUvhlC+mUn4nXDoigQ7T7AOWa/Qgv/edmpeBM7LQsJ/3eNMt00982nHg=="}'
)
ws.send('{"topic":"user_event_trigger.*","op":"sub"}')
# %%
for i in range(3):
