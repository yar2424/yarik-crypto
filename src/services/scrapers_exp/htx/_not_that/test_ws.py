...
# %%
ws = create_connection("wss://www.htx.com/-/s/pro/ws")
# %%
# ws.send('{"req":"market.symbols"}')
# ws.send('{"sub":"market.overviewv2"}')
ws.send('{"sub":"market.btcusdt.detail","symbol":"btcusdt"}')  # seems to not work
# ws.send('{"req":"market.btcusdt.trade.detail","symbol":"btcusdt"}')
# %%
for i in range(3):
