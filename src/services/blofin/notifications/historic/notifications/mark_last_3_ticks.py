...
from src.services.blofin.notifications.historic.types_ import (
    NotifTriggerParams,
    NotifWithPriority,
)
...
notif_name_to_chats = {
    "mark_last-0_05-3_ticks": ["all", "prior", "individ_blofin"],
    "mark_last-0_5-3_ticks": ["all", "prior", "individ_blofin"],
    "mark_last-2-3_ticks": ["all", "prior", "individ_blofin"],
    "mark_last-4-3_ticks": ["all", "prior", "individ_blofin"],
    "mark_last-8-3_ticks": ["all", "prior", "individ_blofin"],
}
